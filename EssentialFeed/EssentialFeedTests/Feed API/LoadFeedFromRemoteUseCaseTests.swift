...
class LoadFeedFromRemoteUseCaseTests: XCTestCase {
    ...
    func test_load_doesNotDeliverResultAfterSUTInstanceHassBeenDeallocated() {
    ...
    private func makeItem(id: UUID, description: String?,
                          location: String? , imageURL: URL) -> (model: FeedImage, json: [String: Any]) {
        let item = FeedImage(
            id: id,
