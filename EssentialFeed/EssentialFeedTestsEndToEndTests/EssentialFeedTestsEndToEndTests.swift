//
//  EssentialFeedTestsEndToEndTests.swift
//  EssentialFeedTestsEndToEndTests
//
...
final class EssentialFeedTestsEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case let .failure(error):
            XCTFail("Expected succeessful feed result, got \(error) instead")
        default:
            XCTFail("Expected succeessful feed result, got no result instead")
        }
    }
